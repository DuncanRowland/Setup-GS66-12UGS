...
Fixed in kernel update (5.15.0-41-generic). After Nvidia driver is installed, boot to recover mode and install nvidia-prime. Run prime-select on-demand and reboot.
